...
const formulas: Formula[] = [
  // --- Fórmulas Enterais (Sistema Aberto) ---
  {
    ...
    type: "standard",
    systemType: "open",
    composition: { calories: 125, density: 1.25, protein: 6.5625, sodium: 105, potassium: 160, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
  ...
  },
  {
    ...
    type: "peptide",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 6.75, sodium: 90, potassium: 215, fiber: 0, waterContent: 76 },
    presentations: [200],
    referenceVolume: 200,
  ...
  },
  {
    ...
    type: "high-protein",
    systemType: "open",
    composition: { calories: 137, density: 1.37, protein: 9.9325, sodium: 100, potassium: 155, fiber: 0.5, waterContent: 76 },
    presentations: [200],
    referenceVolume: 200,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "renal",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 6.375, sodium: 145, potassium: 220, fiber: 0.8, waterContent: 76 },
    presentations: [200],
    referenceVolume: 200,
  ...
  },
  {
    ...
    type: "standard",
    systemType: "open",
    composition: { calories: 100, density: 1.0, protein: 2.75, sodium: 35, potassium: 122, fiber: 0, waterContent: 81 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "open",
    composition: { calories: 148, density: 1.48, protein: 4.07, sodium: 51, potassium: 180, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "standard",
    systemType: "open",
    composition: { calories: 100, density: 1.0, protein: 3.75, sodium: 61, potassium: 177, fiber: 0, waterContent: 81 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 5.625, sodium: 61, potassium: 177, fiber: 1.0, waterContent: 81 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "fiber",
    systemType: "open",
    composition: { calories: 126, density: 1.26, protein: 4.725, sodium: 115, potassium: 210, fiber: 1.7, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 4.125, sodium: 40, potassium: 97, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "renal",
    systemType: "open",
    composition: { calories: 200, density: 2.0, protein: 7.5, sodium: 87, potassium: 135, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "diabetic",
    systemType: "open",
    composition: { calories: 106, density: 1.06, protein: 7.685, sodium: 72, potassium: 220, fiber: 1.6, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-protein",
    systemType: "open",
    composition: { calories: 148, density: 1.48, protein: 9.99, sodium: 112, potassium: 197, fiber: 0, waterContent: 81 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "standard",
    systemType: "open",
    composition: { calories: 102, density: 1.02, protein: 4.08, sodium: 300, potassium: 670, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "open",
    composition: { calories: 154, density: 1.54, protein: 5.775, sodium: 70, potassium: 160, fiber: 0, waterContent: 81 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "immune",
    systemType: "open",
    composition: { calories: 100, density: 1.0, protein: 3.75, sodium: 70, potassium: 160, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-protein",
    systemType: "open",
    composition: { calories: 130, density: 1.3, protein: 4.875, sodium: 70, potassium: 160, fiber: 0.8, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "renal",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 6.75, sodium: 115, potassium: 60, fiber: 0, waterContent: 81 },
    presentations: [200],
    referenceVolume: 200,
    referenceTimesPerDay: 1,
  ...
  // --- Fórmulas Enterais (Sistema Fechado) ---
  {
    ...
    type: "peptide",
    systemType: "closed",
    composition: { calories: 135, density: 1.35, protein: 6.75, sodium: 85, potassium: 150, fiber: 0, waterContent: 76 },
  ...
  },
  {
    ...
    type: "high-protein",
    systemType: "closed",
    composition: { calories: 130, density: 1.3, protein: 7.475, sodium: 103, potassium: 239, fiber: 0.8, waterContent: 76 },
    presentations: [1000],
    referenceVolume: 1056,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-protein",
    systemType: "closed",
    composition: { calories: 150, density: 1.5, protein: 8.25, sodium: 132, potassium: 250, fiber: 0, waterContent: 76 },
    presentations: [1000],
    referenceVolume: 1056,
    referenceTimesPerDay: 1,
    referencePackSize: 1000,
  ...
  },
  {
    ...
    type: "peptide",
    systemType: "closed",
    composition: { calories: 101, density: 1.01, protein: 9.3425, sodium: 70, potassium: 150, fiber: 0.05, waterContent: 81 },
    presentations: [1000],
    referenceVolume: 1056,
    referenceTimesPerDay: 1,
    referencePackSize: 1000,
  ...
  },
  {
    ...
    type: "standard",
    systemType: "open",
    composition: { calories: 50, density: 0.5, protein: 1.875, sodium: 30.5, potassium: 88.5, fiber: 0, waterContent: 87 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "open",
    composition: { calories: 150, density: 1.5, protein: 6, sodium: 38.4, potassium: 192, fiber: 0, waterContent: 76 },
    presentations: [100],
    referenceVolume: 100,
    referenceTimesPerDay: 1,
  ...
  },
  {
    ...
    type: "high-calorie",
    systemType: "closed",
    composition: { calories: 150, density: 1.5, protein: 6.375, sodium: 145, potassium: 220, fiber: 0.8, waterContent: 81 },
    presentations: [1000],
    referenceVolume: 1056,
    referenceTimesPerDay: 1,
    referencePackSize: 1000,
